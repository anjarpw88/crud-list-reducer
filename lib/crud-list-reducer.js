...
exports.CrudListReducerGenerator = undefined;
...
var Reduce = function Reduce(config) {
  ...
  var reducerWrapper = new _reduxWrapperExtended.ReducerWrapper(initialState);
  var actionDict = {};
  ...
  var obj = {
    ...
    generate: function generate() {
      ...
      return {
        ...
        getSyncedList: function getSyncedList(state) {
        ...
        getComputedValues: function getComputedValues(state) {
          return {
